...
Summary:";
    ...
    {
        using (Activity activity = ActivitySource.StartActivity("DocumentService.SearchDocuments"))
        {
            try
            {
                var query = @"
    ...
    {
        using (Activity activity = ActivitySource.StartActivity("DocumentService.SummarizeDocument"))
        {
            try
            {

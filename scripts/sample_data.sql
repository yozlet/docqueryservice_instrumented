...
-- Generated on 2025-09-24 12:30:16
-- Total documents: 500
...
('Armenia', 'ARM', 'Unknown'),
('Azerbaijan', 'AZE', 'Unknown'),
('Bangladesh', 'BAN', 'Unknown'),
('Benin', 'BEN', 'Unknown'),
('Bhutan', 'BHU', 'Unknown'),
('Bosnia and Herzegovina', 'BOS', 'Unknown'),
('Brazil', 'BRA', 'Unknown'),
('Burkina Faso', 'BUR', 'Unknown'),
('Burundi', 'BUR', 'Unknown'),
('Cabo Verde', 'CAB', 'Unknown'),
('Cambodia', 'CAM', 'Unknown'),
('Cameroon', 'CAM', 'Unknown'),
('Caribbean', 'CAR', 'Unknown'),
('Central Africa', 'CEN', 'Unknown'),
('Central African Republic', 'CEN', 'Unknown'),
('Chad', 'CHA', 'Unknown'),
('China', 'CHI', 'Unknown'),
('Colombia', 'COL', 'Unknown'),
('Comoros', 'COM', 'Unknown'),
('Congo, Democratic Republic of', 'CON', 'Unknown'),
('Congo, Republic of', 'CON', 'Unknown'),
...
('Europe and Central Asia', 'EUR', 'Unknown'),
('Gabon', 'GAB', 'Unknown'),
...
('Latin America and Caribbean', 'LAT', 'Unknown'),
('Lebanon', 'LEB', 'Unknown'),
('Liberia', 'LIB', 'Unknown'),
...
('Senegal', 'SEN', 'Unknown'),
('Senegal,Chad,Mauritania,Burkina Faso,Mali,Niger', 'SEN', 'Unknown'),
('Serbia', 'SER', 'Unknown'),
('Sierra Leone', 'SIE', 'Unknown'),
('Solomon Islands', 'SOL', 'Unknown'),
('Somalia, Federal Republic of', 'SOM', 'Unknown'),
('South Africa', 'SOU', 'Unknown'),
('South Sudan', 'SOU', 'Unknown'),
('Southwest Indian Ocean', 'SOU', 'Unknown'),
...
('Environmental and Social Assessment', 'Project Documents'),
...
('Implementation Completion Report Review', 'Project Documents'),
('Annual Report', 'Publications & Research'),
('Environmental and Social Assessment; Social Assessment; Environmental Assessment', 'Project Documents')
...
INSERT INTO documents (
    ...
    'pdfs/BOSIB-9b099c36-ec91-4c49-a173-24653c9e3697.pdf',
    'PENDING',
    'English',
    'Ethiopia',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/BOSIB-f3c4c161-7123-4c2d-a412-7d3be29fa34a.pdf',
    'PENDING',
    'English',
    'Tajikistan',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/IDU-7acd5b7f-043a-4f3c-a963-fa12b7096a84.pdf',
    'PENDING',
    'English',
    'World',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P511828-705be4ac-50c6-4243-a6cd-73d947cfcf55.pdf',
    'PENDING',
    'English',
    'Sri Lanka',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P178598-eca71dfc-0099-4397-b3ed-5e73f2b1edbb.pdf',
    'PENDING',
    'English',
    'Burkina Faso',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/IDU-4dbeb6f9-cd9c-45e8-9557-35fba01b0036.pdf',
    'PENDING',
    'English',
    'World',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P506083-0b9341e6-aefc-4c82-b1c1-263b0dcd7b9a.pdf',
    'PENDING',
    'English',
    'Ukraine',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P171627-f0bb1665-5cf0-46ab-9d39-7bb2a7488419.pdf',
    'PENDING',
    'English',
    'Ethiopia',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P506528-7b62f98c-1528-48d8-bcaf-d32e9eaed7e9.pdf',
    'PENDING',
    'English',
    'Burkina Faso',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P179558-625f8913-26fa-4d67-8619-43b6752549af.pdf',
    'PENDING',
    'English',
    'Mauritania',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P501985-90b75bed-aa38-46bc-9dfe-431134be79fa.pdf',
    'PENDING',
    'English',
    'Nepal',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P172834-a90b0a4e-c6c9-484c-b7bf-8c13011ca3b6.pdf',
    'PENDING',
    'English',
    'Pakistan',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P504629-f8992420-6b24-4296-bf70-918431a5811f.pdf',
    'PENDING',
    'English',
    'Sudan',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P173830-4f3f1f2d-6594-465f-8b03-da42f7299505.pdf',
    'PENDING',
    'English',
...
INSERT INTO documents (
    ...
    'pdfs/P179363-5cff9b86-e90b-4cb5-a39e-e2b9ec196d20.pdf',
    'PENDING',
    'English',
    'Moldova',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/IDU-b811c80c-834e-4e93-9b99-1214ee5b1884.pdf',
    'PENDING',
    'French',
    'World',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/IDU-97c071f0-a309-4213-9ca4-96ddea75bf3f.pdf',
    'PENDING',
    'Portuguese',
    'World',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P170734-6628aa03-b7dd-434c-a938-aae425668f40.pdf',
    'PENDING',
    'English',
    'Nigeria',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P157043-9a5d852e-cc3d-4fbc-a471-2b1e7f8d0fa8.pdf',
    'PENDING',
    'English',
    'Peru',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P176375-88084d73-84bf-426a-8163-72fd293050cd.pdf',
    'PENDING',
    'English',
    'Turkiye',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P175731-3cb5b7cd-6964-4123-9a05-8c4aaedcf728.pdf',
    'PENDING',
    'English',
...
INSERT INTO documents (
    ...
    'pdfs/P172012-e3fc5206-76a2-422f-b4ee-da3e501abd6a.pdf',
    'PENDING',
    'English',
    'Liberia',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P510691-fbd97f10-0e5e-4b72-a2c1-cf38d5ee1356.pdf',
    'PENDING',
    'English',
    'Brazil',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P173743-a4c560a8-8a41-4584-a3b4-3ac8529b7661.pdf',
    'PENDING',
    'English',
    'Haiti',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/IDU-ea11837f-1b0f-46b5-bc1a-cbdc0e0f7997.pdf',
    'PENDING',
    'Spanish',
    'World',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P179749-5b81308e-fe7c-4505-b7b9-a8795b85791e.pdf',
    'PENDING',
    'English',
    'India',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P504762-58c8e924-7071-4434-9855-506e5497a046.pdf',
    'PENDING',
    'English',
    'Gambia, The',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P179599-3bbea9d4-397d-465b-b112-2e0e1050b2f9.pdf',
    'PENDING',
    'English',
    'Tuvalu',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/TF074190-b4b6c4fe-7282-4a8b-ab79-b5815b347eb4.pdf',
    'PENDING',
    'English',
    '',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P177768-502d7582-334f-4bd5-9859-73c4414957c0.pdf',
    'PENDING',
    'English',
    'Maldives',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P174495-423356b7-4229-456b-a9c8-289154fa0df7.pdf',
    'PENDING',
    'English',
    'Chad',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/40046576_Tornando_as_Escolas_Resilientes_no_Japao___Foco_em.pdf',
    'PENDING',
    'Portuguese',
    'Japan',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P181922-480fa2df-daa0-4761-b70c-a126bd6fea4d.pdf',
    'PENDING',
    'English',
    'Uzbekistan',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P176981-5dbe927e-ca70-4f78-9bb3-3aa35f53fe8d.pdf',
    'PENDING',
    'English',
    'Cabo Verde',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P504281-73b8c18f-e22f-40a0-90d3-ffa05203d542.pdf',
    'PENDING',
    'English',
    'Ethiopia',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P164824-c75e1e62-c2d5-464f-bedf-60853a0f2021.pdf',
    'PENDING',
    'English',
    'Serbia',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P178598-7cbe80aa-9e22-4c31-aaeb-f5acc2058abc.pdf',
    'PENDING',
    'English',
    'Burkina Faso',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P178161-d2bcfd05-644a-43c0-a799-4a1618e113fc.pdf',
    'PENDING',
    'English',
    'Rwanda',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P500588-e4e6fa06-3553-4e91-ba32-392978839b70.pdf',
    'PENDING',
    'English',
    'Tanzania',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P175731-4e2a76ab-c9ea-4577-97a5-84a3425ba66d.pdf',
    'PENDING',
    'English',
    'Eastern and Southern Africa',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P163476-ecff6831-6825-4b3b-9ff3-0a0f3145a964.pdf',
    'PENDING',
    'English',
    'Lebanon',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P181295-6edae685-4d8d-47aa-9243-8eb5bba5069a.pdf',
    'PENDING',
    'English',
    'Solomon Islands',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P181087-e445b986-5fc7-4721-9b55-03a483fdc6b9.pdf',
    'PENDING',
    'English',
    'Nepal',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P502008-5506f083-90e1-4e33-8709-3ebdd59888b7.pdf',
    'PENDING',
    'English',
    'World',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P168539-981251c4-9450-4353-9b4e-ba9b74baf28a.pdf',
    'PENDING',
    'English',
    'OECS Countries',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P174328-293fb75b-9a98-42c1-a9f7-697558f958aa.pdf',
    'PENDING',
    'English',
    'Honduras',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P181237-ba71c044-9585-4802-990e-cce88f3e6a47.pdf',
    'PENDING',
    'English',
...
INSERT INTO documents (
    ...
    'pdfs/P509816-b207dcc3-00d8-4ae1-a1cb-f3e1e94d0ca1.pdf',
    'PENDING',
    'English',
    'Bhutan',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P180932-3327a3a6-b5f6-4ce6-844f-076624992066.pdf',
    'PENDING',
    'English',
    'India',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P178567-f244f24b-16b6-4284-93d8-32d308c6932e.pdf',
    'PENDING',
    'English',
    'Brazil',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P180992-65fcd64e-2344-4d94-ac6a-e6ed771282cb.pdf',
    'PENDING',
    'English',
    'Indonesia',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P178598-8941fde9-40b9-49ba-be56-89e200855efe.pdf',
    'PENDING',
    'English',
    'Burkina Faso',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/IDU-e90e8d80-af94-4d90-bdfc-fc9993b7c3c7.pdf',
    'PENDING',
    'English',
    'Japan',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/IDU-69cad72a-82da-4557-a436-0c082302d5b0.pdf',
    'PENDING',
    'Spanish',
    'Japan',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P508058-6e8916be-1494-4f69-9333-8a3a1b101d45.pdf',
    'PENDING',
    'English',
    'Bangladesh',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P176375-cf3817f8-c846-435e-ba68-94d4ab55d3d6.pdf',
    'PENDING',
    'English',
    'Turkiye',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P508948-7a790184-74d5-4d1f-8cff-10000c796fb2.pdf',
    'PENDING',
    'English',
    'Eswatini',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P172769-b9cd353a-d1ab-4c72-8743-7049b95514fc.pdf',
    'PENDING',
    'English',
    'Western and Central Africa',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P169669-bb2f0312-151b-4658-927d-cc0e832135f4.pdf',
    'PENDING',
    'English',
...
INSERT INTO documents (
    ...
    'pdfs/P168576-4c1caccb-e4aa-446d-b6fe-58360687110e.pdf',
    'PENDING',
    'English',
    'West Bank and Gaza',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P174002-f8f07051-b0fd-4602-af21-68ce2e6970d1.pdf',
    'PENDING',
    'English',
    'Mozambique',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P510227-c5f0205f-5ee5-43c9-9757-cca8bfb6fa51.pdf',
    'PENDING',
    'English',
    'Brazil',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P180848-980daabd-c4df-4314-a796-5df3bf5c97c5.pdf',
    'PENDING',
    'English',
...
INSERT INTO documents (
    ...
    'pdfs/P181490-f0cbc82e-7284-4b6c-a843-c628bcef6cdf.pdf',
    'PENDING',
    'English',
    'Sudan',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P168052-e1edfd38-7cc2-4d48-8235-661eee71a7c9.pdf',
    'PENDING',
    'English',
    'Tajikistan',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P507958-5efb5f3a-f5e5-4474-b19d-f90a881bf06c.pdf',
    'PENDING',
    'English',
    'Honduras',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P510227-8f500c44-ff16-4e56-97ad-aeba485b8a24.pdf',
    'PENDING',
    'English',
    'Brazil',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P174137-d17d6171-1cae-4468-8d91-f8349409dd0f.pdf',
    'PENDING',
    'English',
    'Philippines',
    '',
...
INSERT INTO documents (
    ...
    1,
    NULL,
    'https://documents.worldbank.org/curated/en/099449309242530606/pdf/IDU-e1905823-a9ea-4d57-9779-3fb81100d14a.pdf',
    'pdfs/IDU-e1905823-a9ea-4d57-9779-3fb81100d14a.pdf',
    'PENDING',
    'English',
    'Bangladesh',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P500488-413350e8-ed20-4cca-8981-7a1003beeb7b.pdf',
    'PENDING',
    'English',
    'Mozambique',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P505226-d2844a3a-4bdf-4c0d-a41c-a7254b056c79.pdf',
    'PENDING',
    'English',
    'Nepal',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P170676-4ee311c9-035c-44df-af59-5dc85380a4ad.pdf',
    'PENDING',
    'English',
    'Mongolia',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/IDU-9e8cbb8a-d7d7-4de0-88c4-d823dfc37c03.pdf',
    'PENDING',
    'English',
    'Mozambique',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P172562-c2915c80-8493-47a8-8494-10a8a95f0180.pdf',
    'PENDING',
    'English',
    'Turkiye',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P180085-383626a8-4b17-4d91-aeb7-cafb78308daf.pdf',
    'PENDING',
    'English',
    'Western and Central Africa',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P179284-45763602-e47f-407a-86b3-5bb9279ff65e.pdf',
    'PENDING',
    'English',
    'Lao People''s Democratic Republic',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P176932-e28b6375-10ae-485c-aabd-b5a76db3b387.pdf',
    'PENDING',
    'English',
    'Western and Central Africa',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P500764-53df32be-ca46-471b-ad47-af737e5f0a5d.pdf',
    'PENDING',
    'English',
    'Indonesia',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P158372-fcd78130-7889-483f-90cc-5416d8679f44.pdf',
    'PENDING',
    'English',
    'Uzbekistan',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P178598-0a15582b-8c57-400f-ad06-5cf95248fcb5.pdf',
    'PENDING',
    'English',
    'Burkina Faso',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P507271-b0e6adf0-3a64-4c57-9331-9eb0adc407a4.pdf',
    'PENDING',
    'English',
    'Rwanda',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P176383-ed44fd45-0c13-4870-9bc8-60cb6327cdba.pdf',
    'PENDING',
    'English',
    'Guinea-Bissau',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P506528-c7c091d9-cf56-42df-b57d-f4f54bd95fa8.pdf',
    'PENDING',
    'French',
    'Burkina Faso',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P168539-c35bf5cb-1fc9-46b4-be04-eb1c41d71759.pdf',
    'PENDING',
    'English',
    'OECS Countries',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P160005-ce111366-d999-483c-8dd5-044657806df3.pdf',
    'PENDING',
    'English',
    'Sri Lanka',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P181093-2e5b89c5-f3be-43b3-868c-8890b74bef21.pdf',
    'PENDING',
    'English',
    'Malaysia',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P163673-c0ae668b-2bcc-47d1-83d4-da46fa1b4f77.pdf',
    'PENDING',
    'English',
    'Serbia',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P175483-aaa49e3e-3890-4d14-8fe2-5c37055ed195.pdf',
    'PENDING',
    'English',
    'Djibouti',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P159756-b010ca65-d987-4869-8e6a-687caefcdae2.pdf',
    'PENDING',
    'English',
    'Madagascar',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P174595-6e1037a7-7c92-42dd-aa9d-e60091e94d14.pdf',
    'PENDING',
    'English',
    'Albania',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P162337-26db7b03-172c-43c4-a918-78a0ed3d152b.pdf',
    'PENDING',
    'English',
    'Western and Central Africa',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P178699-188a99b7-0e53-4858-b326-fc6210a71093.pdf',
    'PENDING',
    'English',
...
INSERT INTO documents (
    ...
    'pdfs/P511645-06e90cd6-e597-40fb-9e9b-38330cee8951.pdf',
    'PENDING',
    'English',
    'Brazil',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P508558-5460d58a-f3d9-4559-bb38-0068380939c0.pdf',
    'PENDING',
    'English',
    'Argentina',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P181490-f4a0dce0-c87c-427b-9fab-1a2e7578548c.pdf',
    'PENDING',
    'English',
    'Sudan',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/TF069033-c76dbacc-1c6c-4cf6-b67f-4838695f334e.pdf',
    'PENDING',
    'English',
    '',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P510613-d02b7e68-f2fa-4696-9170-ffdfc7528c28.pdf',
    'PENDING',
    'English',
    'Senegal',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P174684-988355e3-fbb0-48ac-8a5a-4bf065b9ad79.pdf',
    'PENDING',
    'English',
    'Madagascar',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P176763-2035557c-fe0f-4162-a072-04b417dfb137.pdf',
    'PENDING',
    'English',
    'Benin',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P512377-0bab5e83-e792-4fc2-b9d3-7354117cf82e.pdf',
    'PENDING',
    'English',
    'Nepal',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P180409-d40d48e4-1d95-4b48-8c84-9b4355ff6471.pdf',
    'PENDING',
    'English',
...
INSERT INTO documents (
    ...
    'pdfs/P167794-93e4487c-e6b5-4cad-9703-26a6b7a9a42c.pdf',
    'PENDING',
    'English',
    'Ethiopia',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P172769-a5009d9f-bec9-43a6-9cac-f1139e2100b8.pdf',
    'PENDING',
    'English',
    'Western and Central Africa',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P177240-7ff76189-3f24-497e-87b2-58f977db881b.pdf',
    'PENDING',
    'English',
    'Maldives',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P180085-12a681e9-2d71-4d92-917c-237366bac55d.pdf',
    'PENDING',
    'English',
    'Western and Central Africa',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P508558-1edc8e30-9116-4a65-974d-9086304ea90a.pdf',
    'PENDING',
    'English',
    'Argentina',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P500561-ef690863-4138-44b6-86bd-835f7d8ca0fc.pdf',
    'PENDING',
    'English',
    'Benin',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P180982-055602d9-bbec-482e-9220-b96668a9ded4.pdf',
    'PENDING',
    'English',
...
INSERT INTO documents (
    ...
    'pdfs/P167359-2a030c59-f625-4810-9d5d-6ce04ba5129d.pdf',
    'PENDING',
    'English',
    'Benin',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P510448-649ed815-0d77-4b0e-a592-2d1316af245d.pdf',
    'PENDING',
    'English',
    'Liberia',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P154440-a06a0096-532d-4884-98ed-5d83c76c33a6.pdf',
    'PENDING',
    'English',
    'Madagascar',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P508550-92065c8a-e60c-49e2-b175-f15381836c87.pdf',
    'PENDING',
    'English',
    'Pacific 1',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P179233-56949bcd-8156-464f-8bac-79edeeb963ae.pdf',
    'PENDING',
    'English',
    'Gambia, The',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P176450-abbd1855-2edd-4791-84e0-b7e57498680a.pdf',
    'PENDING',
    'English',
    'Central African Republic',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P510184-21f297f2-b043-4224-8fd3-4b4f80d05bb1.pdf',
    'PENDING',
    'English',
    'Philippines',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P180638-66812344-8464-4f85-b0ab-a4a17ea230f7.pdf',
    'PENDING',
    'English',
    'Uruguay',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/TF073570-74890be0-d225-42bd-9cbb-d00ae0160517.pdf',
    'PENDING',
    'English',
    '',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P000755-60835a9d-e52b-4769-9c24-39a682c944cb.pdf',
    'PENDING',
    'English',
    '',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P163734-931b0b39-25a9-4bfc-87c4-83524396a1b7.pdf',
    'PENDING',
    'English',
    'Tajikistan',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P179010-86f058f2-5622-4c50-885b-a9cc12d234bc.pdf',
    'PENDING',
    'English',
    'Tunisia',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P144271-c1839584-0c28-4c95-a6d3-7b6718127cb0.pdf',
    'PENDING',
    'English',
    'Colombia',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P172341-de87e197-f786-48c2-a836-0885457fcd78.pdf',
    'PENDING',
    'English',
...
INSERT INTO documents (
    ...
    'pdfs/P502464-ed8c67cb-7429-49ff-9ff9-cddc92bde8df.pdf',
    'PENDING',
    'English',
    'Malawi',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P167156-26f0a114-95ac-477e-afa2-87c1349f4c42.pdf',
    'PENDING',
    'English',
    'Nigeria',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P167156-83af1f81-2ade-4e00-b095-33bcedacf658.pdf',
    'PENDING',
    'English',
    'Nigeria',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P178040-5dc3e82e-e887-43ce-85f5-d6708379c1c2.pdf',
    'PENDING',
    'English',
    'Angola',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P180245-8b39ea29-9345-42d8-b4de-f7496e3bc93b.pdf',
    'PENDING',
    'English',
    'Ukraine',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P171833-dda714c4-95f1-408d-ba2e-21c2041bd148.pdf',
    'PENDING',
    'English',
    'Caribbean',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P180634-028ff612-7ba4-4057-958d-b9dcb695d25a.pdf',
    'PENDING',
    'English',
    'India',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P162263-accf6856-9b0e-4951-8443-3b72103a2564.pdf',
    'PENDING',
    'English',
    'Uzbekistan',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P180665-8b91f9b0-5cf2-461c-8e07-8ae37514a05e.pdf',
    'PENDING',
    'English',
    'Nepal',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P174593-087e9b8b-ef0b-45d4-8ee9-0c05c1e4767f.pdf',
    'PENDING',
    'English',
    'India',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/TF072858-da9becad-ba4b-41cd-a5a4-fcf247e2cfbd.pdf',
    'PENDING',
    'English',
    '',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P170861-bd272fbd-b11f-4f14-b131-18efc2fba633.pdf',
    'PENDING',
    'English',
    'World',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P169677-dc6c3c40-cb5e-4319-96d8-d79e053aacc1.pdf',
    'PENDING',
    'English',
    'El Salvador',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P177786-dd0f6593-3ae0-41ae-94b8-fa77dad31048.pdf',
    'PENDING',
    'French',
    'Congo, Republic of',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P170640-cb0338ce-d409-4286-8034-2cce7d673f63.pdf',
    'PENDING',
    'English',
    'Lao People''s Democratic Republic',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P180965-e957ff99-8de1-4562-b0ff-20d505ffa42d.pdf',
    'PENDING',
    'English',
    'Tonga',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P180575-7acdb01b-6d0c-44f6-b987-e866a3e3a384.pdf',
    'PENDING',
    'English',
    'Rwanda',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P167794-77283df2-b8d7-4756-bddb-c91171dd8c38.pdf',
    'PENDING',
    'English',
    'Ethiopia',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/IDU-b41fb633-a2a1-42ec-bc7e-d7555bb359f2.pdf',
    'PENDING',
    'English',
    'Peru',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P179447-4dbf8c5c-84e6-43c8-8858-46191cf59e53.pdf',
    'PENDING',
    'English',
    'Nigeria',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P174002-ddff2652-0f9d-4b7f-a68d-f5fd7efb20cb.pdf',
    'PENDING',
    'English',
    'Mozambique',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P509428-0fd29ca4-40c0-4950-83a7-5d5a4a805e23.pdf',
    'PENDING',
    'English',
    'Lebanon',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P177328-973bad0d-0ae4-4492-9ef8-a8fc307d14f6.pdf',
    'PENDING',
    'English',
    'Namibia',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P181166-c8ea693e-7d79-48a9-a80d-0542e6e4e850.pdf',
    'PENDING',
    'English',
    'Honduras',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P504222-712cb867-257b-4c7f-9bfb-063b2c9f9799.pdf',
    'PENDING',
    'English',
    'Haiti',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P165973-4199900d-91e7-451a-8a5e-fd0b083faf36.pdf',
    'PENDING',
    'English',
    'Suriname',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P168061-58eb73c0-e778-4edc-9024-fada25ae3737.pdf',
    'PENDING',
    'English',
    'China',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P180707-2b8a76ab-6457-4709-bdc3-a4813db78384.pdf',
    'PENDING',
    'English',
    'Pakistan',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P178808-510159af-3833-4cef-ac1c-60ea96723e80.pdf',
    'PENDING',
    'English',
    'Ethiopia',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P176935-73af7a0c-5f2c-4345-ab77-7fd5cb8e1954.pdf',
    'PENDING',
    'English',
    'Nigeria',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P177845-efc8d221-ae6b-4b6c-b400-269d0a17f64c.pdf',
    'PENDING',
    'English',
    'Albania',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P179988-122e918a-88d3-4e00-b124-579fdeabc054.pdf',
    'PENDING',
    'English',
    'Armenia',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P179383-3812144d-64c6-4596-b6fb-93038f0aac92.pdf',
    'PENDING',
    'English',
    'Mauritania',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P176761-9f169378-13f2-438f-a95f-ac7b3197fcd1.pdf',
    'PENDING',
    'English',
    'South Sudan',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P506599-764a5758-c15e-4828-b613-8f1875054cfb.pdf',
    'PENDING',
    'English',
    'World',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P180384-8329a1f8-9fa0-4482-96de-662c681b1342.pdf',
    'PENDING',
    'English',
    'Haiti',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P158622-e33ab111-ad58-4e5a-b44c-2df641723a67.pdf',
    'PENDING',
    'English',
    'China',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P166656-70b63fe9-8f29-461b-b318-f255fdcbe564.pdf',
    'PENDING',
    'English',
    'Viet Nam',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P175266-5252be38-33fe-4575-b7ce-1355a4c8fdc8.pdf',
    'PENDING',
    'English',
    'Mozambique',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P167798-436e24f1-69b6-42fb-8d6a-18132e144c94.pdf',
    'PENDING',
    'English',
    'Western and Central Africa',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P180349-c53326eb-a48b-456e-8c90-ecc589b4d3f4.pdf',
    'PENDING',
    'English',
    'Dominican Republic',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P171144-b315f818-59fa-49f2-8c26-4b467b4b7bd9.pdf',
    'PENDING',
    'English',
    'Bangladesh',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P167350-8b59a6ac-acee-49c3-8b05-2e0ef5e43b0c.pdf',
    'PENDING',
    'English',
    'India',
    '',
...
INSERT INTO documents (
    ...
    '40046402',
    'Disclosable Version of the ISR - Mozambique Health Emergency Preparedness Response and Resilience Project Using the Multiphase Programmatic Approach - P511558 - Sequence No : 1',
    '2025-09-23',
    '',
    'Implementation Status and Results Report',
    'Project Documents',
    NULL,
    NULL,
    'https://documents.worldbank.org/curated/en/099092325120578876/pdf/P511558-3a5f0bd8-5e28-4519-8381-a5d4c6cebce5.pdf',
    'pdfs/P511558-3a5f0bd8-5e28-4519-8381-a5d4c6cebce5.pdf',
    'PENDING',
    'English',
    'Mozambique',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P162594-3a95b0eb-dd31-41dc-88d2-e431b6e49052.pdf',
    'PENDING',
    'English',
    'Colombia',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P171528-5338b92c-61fa-4864-b1ee-0b4a7dbdf8e5.pdf',
    'PENDING',
    'English',
    'Caribbean',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P152057-801f4bb0-ad7e-4d11-a58d-33e9726b950a.pdf',
    'PENDING',
    'English',
    'Honduras',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P175269-8c8e704c-e06d-45f5-9e8d-294d2b4b7ef4.pdf',
    'PENDING',
    'English',
    'Madagascar',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P177048-1f873883-a664-4816-8750-9c3f129cf716.pdf',
    'PENDING',
    'English',
    'Kenya',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P179447-974803cc-9ed7-4477-ab55-a49eb7c75f22.pdf',
    'PENDING',
    'English',
    'Nigeria',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P132824-0843bd3b-f668-416d-9cb9-ff8b4bcf04ce.pdf',
    'PENDING',
    'English',
    'Gabon',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P508191-b724d48d-5d5a-401e-a2b4-e20323a041c0.pdf',
    'PENDING',
    'English',
    'Tanzania',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/TF074035-8f073e8c-f06e-4dc7-966c-68ffca97747e.pdf',
    'PENDING',
    'English',
    '',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P508558-7762b7e4-f1b3-43b5-a3b8-a200b1d0dac5.pdf',
    'PENDING',
    'English',
    'Argentina',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P179067-ae05de86-7ad0-4f32-9c77-60fe1768577a.pdf',
    'PENDING',
    'English',
    'St Maarten',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P177816-8aab9c50-7263-4994-baed-e5dbbaed6b64.pdf',
    'PENDING',
    'English',
    'Eastern and Southern Africa',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P173671-fce8f677-0640-425b-9aad-f4dbd3440992.pdf',
    'PENDING',
    'English',
    'Indonesia',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P176811-f4cbe003-d27c-4739-aded-32cb3470581d.pdf',
    'PENDING',
    'English',
    'Madagascar',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P512407-6ea1b756-cfbc-467d-9522-49be1f144ed3.pdf',
    'PENDING',
    'English',
    'Viet Nam',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P512407-3089b6b6-1182-49f4-9528-ab29a7c17195.pdf',
    'PENDING',
    'English',
    'Viet Nam',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P166222-2408735c-84b9-4a3f-ac8d-21972c8121e7.pdf',
    'PENDING',
    'English',
    'Papua New Guinea',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P177663-f060c364-9296-4708-a6c0-192b3d33b0ef.pdf',
    'PENDING',
    'English',
    'South Sudan',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P162278-c630f8bc-b6ea-406e-918e-15d9e703e99a.pdf',
    'PENDING',
    'English',
    'Peru',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P509818-6d8e8fbd-0b07-4fa9-bad0-8ad18471d944.pdf',
    'PENDING',
    'English',
    'Kyrgyz Republic',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P171645-f83236db-83b1-425a-916e-5a021e170a1e.pdf',
    'PENDING',
    'English',
    'Turkiye',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P175952-2cda49cd-b4fb-40b6-a5e5-cea5544a08a1.pdf',
    'PENDING',
    'English',
    'Tajikistan',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P178040-603ae5cf-347b-4da7-be9e-34a6a84af44d.pdf',
    'PENDING',
    'English',
    'Angola',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/IDU-6a52e81b-22d9-4e0c-b520-931c26858b54.pdf',
    'PENDING',
    'English',
    'World',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P167794-684d269b-1aab-4961-b69c-56e8902cee29.pdf',
    'PENDING',
    'English',
    'Ethiopia',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P157575-8e50e685-c16d-46de-9800-490e3fbbba3e.pdf',
    'PENDING',
    'English',
    'Panama',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P178582-a2c1b917-8448-4a7a-8aa1-ef4206d6dea6.pdf',
    'PENDING',
    'English',
    'Jamaica',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P175987-b0482b53-0e17-4096-971a-548402bda131.pdf',
    'PENDING',
    'English',
    'Gabon',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P161477-edcdb35b-9dd1-40b6-8ac8-28c16f714908.pdf',
    'PENDING',
    'English',
    'Senegal',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P174637-a82da8e4-89b8-4bd3-8fc4-b8e059ed6b24.pdf',
    'PENDING',
    'English',
    'Papua New Guinea',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P173830-3bbbc1e0-94d4-44e3-b43d-e120cc88f60b.pdf',
    'PENDING',
    'English',
    'Western and Central Africa',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P178699-21688849-d0b3-421a-8b64-aaaa26cce349.pdf',
    'PENDING',
    'English',
    'Central African Republic',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P178819-9c67ef71-dd02-4153-805f-69c6d0a4e193.pdf',
    'PENDING',
    'English',
    'Tajikistan',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P179037-033da2bc-d8bb-4522-9dfa-4df7ff3a0f7c.pdf',
    'PENDING',
    'English',
    'Peru',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P157891-f9ee0956-7840-4249-bece-a91e2f7b2942.pdf',
    'PENDING',
    'English',
    'Nigeria',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P172352-7d3bf633-f387-4f03-a7f3-0e54635f8d9d.pdf',
    'PENDING',
    'English',
    'Costa Rica',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P163957-a9cde11c-7ee9-4887-93bf-72b665b68cfc.pdf',
    'PENDING',
    'English',
    'Maldives',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P504420-91e87e71-e848-4b1b-8bba-b4abbb89b933.pdf',
    'PENDING',
    'English',
    'Uzbekistan',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P161706-460330fd-71fd-421a-9b83-d8dc8fbfa392.pdf',
    'PENDING',
    'English',
    'Western and Central Africa',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P509153-a0e47b66-ed10-49ff-9a58-881f6160b39e.pdf',
    'PENDING',
    'English',
    'Western and Central Africa',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P177009-d499e7eb-b8b2-4d4c-86e9-ae75e9878ab1.pdf',
    'PENDING',
    'English',
    'World',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P178808-c0ef12f7-de57-43ba-a444-16b332874b36.pdf',
    'PENDING',
    'English',
    'Ethiopia',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P181604-1a448955-d365-4abc-ac6d-bed54bfb519c.pdf',
    'PENDING',
    'English',
    'Ukraine',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P508310-cd650c30-81f5-4163-9314-7fbe984927de.pdf',
    'PENDING',
    'English',
    'Armenia',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P171933-7d65f8fe-2fca-45c3-b975-bed20899505a.pdf',
    'PENDING',
    'English',
    'Ghana',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P505190-5fe4626f-abec-4259-99b1-10c89298debe.pdf',
    'PENDING',
    'English',
    'India',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P510072-3f171f5e-04f5-4d2e-ad45-517b8ff9564b.pdf',
    'PENDING',
    'English',
    'East Asia and Pacific',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P162009-90b7bbbd-2d0f-43f3-8ad4-40105f2b7b87.pdf',
    'PENDING',
    'English',
    'Nigeria',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P506356-f6b70651-8203-4ddd-8c97-1e942a2ea119.pdf',
    'PENDING',
    'English',
    'Tuvalu',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P180244-45fa7706-b777-420f-9ff2-921e143cf89e.pdf',
    'PENDING',
    'English',
    'Western and Central Africa',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P173367-9eea5958-8fe3-4244-b023-4b071201ba57.pdf',
    'PENDING',
    'English',
    'Lebanon',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P157043-d3972536-8acb-4222-9953-190ae3bcf02d.pdf',
    'PENDING',
    'English',
    'Peru',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P177009-25e779d1-f9b1-47e1-bedc-691ccc829861.pdf',
    'PENDING',
    'English',
    'World',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P180334-58f44291-9113-4d4a-b4c5-af48009a1760.pdf',
    'PENDING',
    'English',
    'Lebanon',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P180742-b59ee6ed-25e7-48a3-88e1-fcd81bfb7a41.pdf',
    'PENDING',
    'English',
    'Tanzania',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P160865-4e395eb5-4d70-4458-bf14-0cfb0d22d2fc.pdf',
    'PENDING',
    'English',
    'Nigeria',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P508310-1aa65835-110c-4897-9cab-b66147dd3f37.pdf',
    'PENDING',
    'English',
    'Armenia',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P163260-79d8dfcf-090b-4a96-bea3-87bbd6759583.pdf',
    'PENDING',
    'English',
    'Dominican Republic',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P131324-81625dda-e3af-4e1a-b2f8-a664ce23cf86.pdf',
    'PENDING',
    'English',
    'Pakistan',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P177627-952e6a32-cc42-4511-a760-8352dabd9b1a.pdf',
    'PENDING',
    'English',
...
INSERT INTO documents (
    ...
    'pdfs/P158000-931e4123-3be3-45f2-a091-4bfc43045f0f.pdf',
    'PENDING',
    'English',
    'Brazil',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/TF050576-0343455d-86ad-4528-a2d7-f5bb54df97d5.pdf',
    'PENDING',
    'English',
    '',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P179128-d635001f-374a-4ba0-b11f-0f1c1f6929d7.pdf',
    'PENDING',
    'English',
    'Turkiye',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P152057-9878a7cd-bf80-48c2-8092-36133d4be1d9.pdf',
    'PENDING',
    'English',
    'Honduras',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P507415-6bcc62ec-e237-4628-89a2-5779f3531851.pdf',
    'PENDING',
    'English',
    'East Asia and Pacific',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P162009-3105ad80-b010-44b6-b27d-b2643b71f127.pdf',
    'PENDING',
    'English',
    'Nigeria',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P167894-252eae47-9135-4869-9603-1c6902dc009c.pdf',
    'PENDING',
    'English',
    'Morocco',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P506142-98533d9c-76bc-40a0-a343-b889f0298cf7.pdf',
    'PENDING',
    'English',
    'Brazil',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P175731-9cafb939-bebf-416d-afd3-2a3a2b8f24ff.pdf',
    'PENDING',
    'English',
    'Eastern and Southern Africa',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P508310-c47cafcd-713a-4bbc-8103-9ad4fe990d5e.pdf',
    'PENDING',
    'English',
    'Armenia',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P177816-4d328967-a6f8-4cef-a627-af301d465d2e.pdf',
    'PENDING',
    'English',
    'Eastern and Southern Africa',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P144271-f621b447-7bf5-4189-b41a-6098ec7f301f.pdf',
    'PENDING',
    'English',
    'Colombia',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P178723-40f0c683-7bf0-46d6-a69e-fec37d40a667.pdf',
    'PENDING',
    'English',
    'West Bank and Gaza',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P163742-71d8b53d-914f-4b6c-bbfe-f7fbe88729d1.pdf',
    'PENDING',
    'English',
    'Sri Lanka',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P179242-8ba4ce3f-7aa3-4d46-8c54-d3941d2e51e2.pdf',
    'PENDING',
    'English',
    'Maldives',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P177118-7500ffc6-955f-441e-9c41-548df7054818.pdf',
    'PENDING',
    'English',
    'Cote d''Ivoire',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/IDU-2baaa97f-4072-4de3-862a-d6eb87845cda.pdf',
    'PENDING',
    'English',
    'United States',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/IDU-e843a133-e922-4be0-b186-0b9df853143a.pdf',
    'PENDING',
    'English',
    'Senegal,Chad,Mauritania,Burkina Faso,Mali,Niger',
    '',
    '',
    'A Gender Lens on Adaptive Social Protection to Maximize Impact for Women and Girls in the Sahel: Guidance for the Sahel Adaptive Social Protection Program'
) ON CONFLICT (id) DO NOTHING;
...
INSERT INTO documents (
    ...
    'pdfs/P166013-ff2fbd2a-4427-4c8c-8c68-991cb9005fda.pdf',
    'PENDING',
    'English',
    'Comoros',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P178598-25057a08-8322-45d7-9a57-788d84e596fa.pdf',
    'PENDING',
    'English',
    'Burkina Faso',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P160865-58d48197-aca7-4bec-91dd-6350c07ebb75.pdf',
    'PENDING',
    'English',
    'Nigeria',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P500565-8f7f5633-4515-43be-adfd-588e4d1d1c33.pdf',
    'PENDING',
    'English',
    'Kazakhstan',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P174639-85ad120a-1a51-49f0-8f85-d40557dad499.pdf',
    'PENDING',
    'English',
    'Mozambique',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P178545-11b641c6-5dc2-4462-92b8-b33badb3cf2d.pdf',
    'PENDING',
    'English',
    'Lao People''s Democratic Republic',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P173316-b676c7a4-1920-4be9-8a93-fa4ad42f1edc.pdf',
    'PENDING',
    'English',
    'China',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P173782-695dcc79-f2b9-4d67-aa94-83b233cf5598.pdf',
    'PENDING',
    'English',
    'Georgia',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P175731-1e8ed848-ae8e-49b6-aeef-55f4b16f6f66.pdf',
    'PENDING',
    'English',
    'Eastern and Southern Africa',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/TF069033-017c847d-99a4-4f66-bdec-1c7b4ab9756d.pdf',
    'PENDING',
    'English',
    '',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P180462-1bed6818-67c9-4e41-8542-683453aca314.pdf',
    'PENDING',
    'English',
    'Brazil',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P156239-78c6cd6a-4a76-4eee-b5c2-f34eed057806.pdf',
    'PENDING',
    'English',
    'Colombia',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P179061-2e3ca577-cf20-4728-91d7-a105f0cadeb1.pdf',
    'PENDING',
    'English',
    'World',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P180555-f53a1c6d-c899-4c80-a622-e480ce001cad.pdf',
    'PENDING',
    'English',
    'Brazil',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P162009-02ceddb8-1aa0-42d0-89b4-6db36f68bb37.pdf',
    'PENDING',
    'English',
    'Nigeria',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P180674-5a55dda8-8e7f-4ad1-8e1f-20448cc64332.pdf',
    'PENDING',
    'English',
    'Tuvalu',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P167916-f7f87d72-760c-4742-8c9a-6e68f5de2443.pdf',
    'PENDING',
    'English',
    'Eastern and Southern Africa',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P179337-9d0c9b0a-59da-4ff4-96a0-08b3d46ad4d4.pdf',
    'PENDING',
    'English',
    'India',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P176317-98c71c79-cfa5-4065-9f55-c50c2d63f67a.pdf',
    'PENDING',
    'English',
    'Philippines',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P178644-23fe1d7c-33ff-446f-aad2-a9faa50834ea.pdf',
    'PENDING',
    'English',
    'Cabo Verde',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P177009-9e10446f-c635-4d6b-8f6a-ca41b2e7fb7c.pdf',
    'PENDING',
    'English',
    'World',
    '',
...
INSERT INTO documents (
    ...
    NULL,
    NULL,
    'https://documents.worldbank.org/curated/en/099092225140011559/pdf/P160865-1b139da4-3679-4ea0-84bc-4dbaf525854e.pdf',
    'pdfs/P160865-1b139da4-3679-4ea0-84bc-4dbaf525854e.pdf',
    'PENDING',
    'English',
    'Nigeria',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P180555-726c87aa-f5ed-4056-a94d-4a0741d40651.pdf',
    'PENDING',
    'English',
    'Brazil',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P180860-fef70106-9e3f-4e59-a3a6-49b9ba456b9c.pdf',
    'PENDING',
    'English',
    'Indonesia',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P173746-e44ddab9-339f-469b-a671-f09e8bb57a0a.pdf',
    'PENDING',
    'English',
    'China',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/IDU-8a84aae6-2bb7-4b31-b365-37ab4921f3f0.pdf',
    'PENDING',
    'English',
    'Ghana',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P180171-0564b0be-f615-4381-a6a8-8b7463ff8375.pdf',
    'PENDING',
    'English',
    'Eastern and Southern Africa',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P175791-f01e8c3e-6641-46a3-b104-94256e4729df.pdf',
    'PENDING',
    'English',
    'Yemen, Republic of',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P175483-30971c43-41d3-42de-88e3-19b5124c1ead.pdf',
    'PENDING',
    'English',
    'Djibouti',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P172562-322dda9d-d0f0-460b-8355-6a28d0c89462.pdf',
    'PENDING',
    'English',
    'Turkiye',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P177009-120ea6cd-569e-4343-8b0b-fe59f5dbb626.pdf',
    'PENDING',
    'English',
    'World',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P179749-2dc88e94-41de-4dd1-ae99-22ebe95876bd.pdf',
    'PENDING',
    'English',
    'India',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P181014-d368dfc2-7950-48f1-9e7d-40ac1bf73899.pdf',
    'PENDING',
    'English',
...
INSERT INTO documents (
    ...
    'pdfs/P506142-09141b0e-d975-4f6f-a4d7-fa34ecbcfa77.pdf',
    'PENDING',
    'English',
    'Brazil',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P162009-703736c8-02a7-48d8-ab5d-fcea4c3d9c81.pdf',
    'PENDING',
    'English',
    'Nigeria',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P175952-f5fde4ee-f4e1-465e-90ad-25b9233e112a.pdf',
    'PENDING',
    'English',
    'Tajikistan',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P512663-280fd1de-7765-49b9-95f2-a759157d475e.pdf',
    'PENDING',
    'English',
    'China',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P512160-18a2b6fb-db59-4f84-ac4d-3701967e3fdb.pdf',
    'PENDING',
    'English',
    'Sao Tome and Principe',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P174822-98c194c8-0e34-4e38-8ba4-d4cb646bfef4.pdf',
    'PENDING',
    'English',
    'Niger',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P511645-5b35b88a-6edf-49ae-84bc-082e898a6194.pdf',
    'PENDING',
    'English',
    'Brazil',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P176724-f19dde01-3fa8-4848-8dc5-b6bf1ff23467.pdf',
    'PENDING',
    'English',
    'Honduras',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P177009-d69f88dc-5167-4dda-aed5-e1d91eb2e9f0.pdf',
    'PENDING',
    'English',
    'World',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P177009-e80a9af9-4fed-4086-aa84-d8cdd6e5c9c3.pdf',
    'PENDING',
    'English',
    'World',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P176981-0e37ce1a-7759-4933-a378-22b4e8972ef9.pdf',
    'PENDING',
    'English',
    'Cabo Verde',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P180555-db1d6796-a1ef-4dbb-8b58-535c2e8f71db.pdf',
    'PENDING',
    'English',
    'Brazil',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P162302-1ab40139-1cd9-4b61-8365-e8dcfa01078d.pdf',
    'PENDING',
    'English',
    'Pakistan',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P177895-b5fbbdaf-f71b-4c3b-beb7-cf8fe7a66be1.pdf',
    'PENDING',
    'English',
    'Moldova',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P181278-b58354e1-fa20-4f33-9535-53cd4b16eb6a.pdf',
    'PENDING',
    'English',
    'Bhutan',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P177240-148ee29c-972e-4574-bbfc-2f062e154ca0.pdf',
    'PENDING',
    'English',
    'Maldives',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P506425-4d2822d2-1687-4580-98a1-a561200ef511.pdf',
    'PENDING',
    'English',
    'Kiribati',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P171050-60ae49f1-2daf-4e5f-8fd2-40afa3555b97.pdf',
    'PENDING',
    'English',
    'Ukraine',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P171613-93de895f-55be-423b-9a14-2e521d7c9561.pdf',
    'PENDING',
    'English',
    'Cote d''Ivoire',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P173334-99d39e63-8066-4193-bff6-675c8d3adb3e.pdf',
    'PENDING',
    'English',
...
INSERT INTO documents (
    ...
    'pdfs/P172988-cd2cdce0-f328-407f-97a0-b403306f7c9c.pdf',
    'PENDING',
    'English',
    'Burundi',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P176272-a53f2084-1fed-4d50-b9cc-f4d35726c98f.pdf',
    'PENDING',
    'English',
    'Samoa',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P505052-7d8a7c9c-a55e-456e-9f69-ddbd6c49f0b6.pdf',
    'PENDING',
    'English',
    'Sri Lanka',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/IDU-a33bc71b-5b6d-4fdb-aded-9fda6978153c.pdf',
    'PENDING',
    'English',
    'Ghana',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P179749-85f8ae97-1b61-4264-b0cc-97d911d3b258.pdf',
    'PENDING',
    'English',
    'India',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P171577-8c183fe9-55ad-4109-921a-d4b96f086167.pdf',
    'PENDING',
    'English',
    'Kazakhstan',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P179242-bc8976f6-49dc-4352-896f-996e02d9b588.pdf',
    'PENDING',
    'English',
    'Maldives',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P177398-ca4fe106-3ec1-42b5-be41-ff90d32b148b.pdf',
    'PENDING',
    'English',
    'South Africa',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P171059-90ae9bad-7f52-49be-9ed0-468340c98a01.pdf',
    'PENDING',
    'English',
    'Sierra Leone',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P512688-a46d05f6-fe3a-4523-99fd-7c6f560fae4a.pdf',
    'PENDING',
    'English',
    'Brazil',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P179003-c683d0f5-dc8d-4142-b2bd-e70a68418a8c.pdf',
    'PENDING',
    'English',
    'Pakistan',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P167996-cc12a86a-304f-4295-9119-06ae905044d4.pdf',
    'PENDING',
    'English',
    'Paraguay',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P178595-d1fcf162-3ed6-420a-87f1-34cdb8df7e5a.pdf',
    'PENDING',
    'English',
    'Jamaica',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P179440-9e9cc632-d19d-4621-83bb-f9708e632653.pdf',
    'PENDING',
    'English',
    'Dominican Republic',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P180708-5de900d7-912a-4077-a4f4-f1664228ab67.pdf',
    'PENDING',
    'English',
    'Yemen, Republic of',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P164302-458684c3-93a8-45b8-9b1c-e02813d9cf48.pdf',
    'PENDING',
    'English',
    'Cote d''Ivoire',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P507415-7f4d6853-aa46-46de-ac26-f36f1681d1a9.pdf',
    'PENDING',
    'English',
    'East Asia and Pacific',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P162009-f264875f-d730-4e64-a149-2bebbf3bd923.pdf',
    'PENDING',
    'English',
    'Nigeria',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P179291-1dd0bd7d-0874-4f43-aabd-38fb8726999e.pdf',
    'PENDING',
    'English',
    'Comoros',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P177009-5e94440f-eb11-4203-951c-405b25393043.pdf',
    'PENDING',
    'English',
    'World',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P174251-8f468483-4e55-4bfe-a1f8-bb2245307ca4.pdf',
    'PENDING',
    'English',
    'Serbia',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P512660-b04c2bcb-44be-4fd1-b7de-315f10087d9b.pdf',
    'PENDING',
    'English',
    'Croatia',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P173278-c31e6f3a-aa50-4096-9f26-5723080fd009.pdf',
    'PENDING',
    'English',
    'Vanuatu',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P179988-a9b304aa-be5f-4a16-87fa-af84c0bd8ff5.pdf',
    'PENDING',
    'English',
    'Armenia',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P174114-ca63bf90-983e-483e-a417-54bf265a02e6.pdf',
    'PENDING',
    'English',
    'Nigeria',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P175791-93fe7ef6-83d4-4a56-bcc2-663b68d927bd.pdf',
    'PENDING',
    'English',
    'Yemen, Republic of',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P165821-40ff0ead-fadf-45ff-a1b0-e767b678ec0a.pdf',
    'PENDING',
    'English',
    'Kiribati',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/TF073553-4f5cc854-cc04-4f74-bea0-180e7dbf4490.pdf',
    'PENDING',
    'English',
    '',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P168608-e8939d7d-0749-4232-96fb-8d8d653cd7fa.pdf',
    'PENDING',
    'English',
    'Sierra Leone',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P508569-d297086a-6766-4a2e-96b9-382bfb508d04.pdf',
    'PENDING',
    'English',
    'Armenia',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P170976-4de44c8e-deeb-4a67-b417-d2aea8af5bb3.pdf',
    'PENDING',
    'English',
    'Cambodia',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P168608-226345e3-4620-4d6e-b9bd-652b4246b1db.pdf',
    'PENDING',
    'English',
    'Sierra Leone',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P170230-7af8bb56-f214-4424-b3a8-e1f0b233ac2a.pdf',
    'PENDING',
    'English',
    'Pakistan',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P176371-eb05bc28-cf40-4f4c-b898-2f210758b258.pdf',
    'PENDING',
    'English',
    'Eastern and Southern Africa',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P504267-e53d48fa-27e2-4d8c-9974-104583342c0b.pdf',
    'PENDING',
    'English',
    'China',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P172524-8a50864b-90e6-42d7-833d-163d8db18ca4.pdf',
    'PENDING',
    'English',
    'Senegal',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P174402-68c9c0a4-8237-4a94-969d-b74a6bfcd55a.pdf',
    'PENDING',
    'English',
    'Pakistan',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P505241-8faae77f-18de-43cf-b1e3-6694605632c7.pdf',
    'PENDING',
    'English',
    'Sri Lanka',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P179046-6b1729b5-adb9-44dc-93e0-f9e7e9793fce.pdf',
    'PENDING',
    'English',
    'Brazil',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P172524-c42ec5f3-0267-4afa-8a24-f9db7aa94900.pdf',
    'PENDING',
    'English',
    'Senegal',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P175791-85240196-e00b-4815-b055-a736a7c33530.pdf',
    'PENDING',
    'English',
    'Yemen, Republic of',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P182113-9632047d-e3c4-40ed-afc9-131375bd99ba.pdf',
    'PENDING',
    'English',
    'Somalia, Federal Republic of',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P175791-ecc227be-ed7f-49c8-aa18-0633205a281c.pdf',
    'PENDING',
    'English',
    'Yemen, Republic of',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P174564-aae3f77b-5661-4635-b476-a0c89ac824c3.pdf',
    'PENDING',
    'English',
    'India',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P148447-61dd6f5d-cdf7-46c0-adcc-362cd132eb3a.pdf',
    'PENDING',
    'English',
    'Ethiopia',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P177881-c91f25b0-ef56-4fc8-9bf2-e997af150295.pdf',
    'PENDING',
    'English',
    'Ethiopia',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P512716-2c25b289-de5b-43bd-bb88-d151ae1be630.pdf',
    'PENDING',
    'English',
    'Angola',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P180245-d6cc3af1-00f6-4e09-a145-7eb191499fcb.pdf',
    'PENDING',
    'English',
    'Ukraine',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P511492-9ee0d48a-9215-418e-99d9-e1c0e32cc0b2.pdf',
    'PENDING',
    'English',
    'Djibouti',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P512716-116928da-c6ce-4e51-b701-559a5ce6767e.pdf',
    'PENDING',
    'English',
    'Angola',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P176274-426cf918-247f-418a-be21-ce54a4c94cbd.pdf',
    'PENDING',
    'English',
    'Central African Republic',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P180171-46c8ed0a-f677-4925-a0b4-94a6886b8a6f.pdf',
    'PENDING',
    'English',
    'Eastern and Southern Africa',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P501274-62daff60-ddf5-47df-b3ed-db2ee0aaed92.pdf',
    'PENDING',
    'English',
    'Bangladesh',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P174114-bdb4026e-f5ff-4d90-b8a8-b5898895f01c.pdf',
    'PENDING',
    'English',
    'Nigeria',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P172434-4d99bb4f-a410-4653-bb71-60a8f6dc168d.pdf',
    'PENDING',
    'English',
    'Somalia, Federal Republic of',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P512154-ca08f190-6858-4bf3-a551-e71e20ca9292.pdf',
    'PENDING',
    'English',
    'Bangladesh',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P508058-fa614cbb-f077-42b7-a814-77354b8b6bf6.pdf',
    'PENDING',
    'English',
    'Bangladesh',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P501274-b18d56eb-80fe-42fd-ab9e-d8d5e720362c.pdf',
    'PENDING',
    'English',
    'Bangladesh',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P509079-e8b0bbf8-90c1-400c-bf40-dd88ad262535.pdf',
    'PENDING',
    'English',
    'Philippines',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P166865-d69ec2a9-bc4d-46b3-bf43-776df33fd037.pdf',
    'PENDING',
    'English',
    'Sri Lanka',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P175676-707a8f87-0af6-41c6-ab85-10d8c10bcbec.pdf',
    'PENDING',
    'English',
    'India',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P501274-0a300518-f9f9-420c-8daa-19217ddc8617.pdf',
    'PENDING',
    'English',
    'Bangladesh',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P501274-8a6d8f3e-7b71-425e-9762-41f146dc598a.pdf',
    'PENDING',
    'English',
    'Bangladesh',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P182053-d6a5a89f-9b69-4483-8332-bd2082046842.pdf',
    'PENDING',
    'English',
    'Madagascar',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P169125-250047d3-1063-45ba-9cce-90675258a3cd.pdf',
    'PENDING',
    'English',
    'El Salvador',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P171331-f6447c86-ea2f-442c-b460-c3310bf3f98a.pdf',
    'PENDING',
    'English',
    'Cambodia',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P507865-d3a472de-3a6a-4928-aae1-cd82b0d6af29.pdf',
    'PENDING',
    'English',
    'India',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P512716-f0c792ac-5de6-450d-b581-977b76ffa55b.pdf',
    'PENDING',
    'Portuguese',
    'Angola',
    '',
...
INSERT INTO documents (
    ...
    '40044597',
    'Revised Environmental and Social Scoping Study for Cahama Xangogo-Ondjiva 220 kV TL - ToR for ESIA ESMP Huila-Cunene Interconnection Project (P512716)',
    '2025-09-19',
    '',
    ...
    NULL,
    NULL,
    'https://documents.worldbank.org/curated/en/099091925150529215/pdf/P512716-0e147897-f75d-4097-8d5d-43d09ee39c59.pdf',
    'pdfs/P512716-0e147897-f75d-4097-8d5d-43d09ee39c59.pdf',
    'PENDING',
    'English',
    'Angola',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P174114-20730391-6a7f-4204-b526-f463afb3bd39.pdf',
    'PENDING',
    'English',
    'Nigeria',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P175803-03af056c-c848-4eb5-a296-8b8875017786.pdf',
    'PENDING',
    'English',
    'Chad',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P172615-64815e98-d409-4238-add0-a10c1a753c9f.pdf',
    'PENDING',
    'English',
    'Pakistan',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P171462-671a36ff-11d9-49ff-887a-6b77c05059fa.pdf',
    'PENDING',
    'English',
    'Rwanda',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P172425-7d24ba8c-3874-403b-86bd-21a7553b204a.pdf',
    'PENDING',
    'English',
    'Cote d''Ivoire',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P160865-757310a1-dc2b-44d1-8cfe-70e64342a64a.pdf',
    'PENDING',
    'English',
    'Nigeria',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P173711-2bf2db90-26b9-4266-bab0-a2239df8490d.pdf',
    'PENDING',
    'English',
    'Madagascar',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P175977-ad34b9a1-7d93-4b02-b433-d1c87a6e5580.pdf',
    'PENDING',
    'English',
    'Honduras',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P167543-1e710840-54d5-4373-bb4a-f47698bf41c2.pdf',
    'PENDING',
    'English',
    'Niger',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P160427-e500cdcb-79c2-4ea8-8335-73e3725eb112.pdf',
    'PENDING',
    'English',
    'Eastern and Southern Africa',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P168185-50bb51f9-f9f9-41db-bf8f-aeda923f8216.pdf',
    'PENDING',
    'English',
    'Western and Central Africa',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P170891-fa3723fb-3f72-4fcc-b33b-b528b0f4e361.pdf',
    'PENDING',
    'English',
    'Albania',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P508171-1c9145ed-faeb-43c0-8e08-b08a2bd17b8e.pdf',
    'PENDING',
    'English',
    'Senegal',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P174114-75bb12fc-c927-41e9-b209-fbe1825c8c29.pdf',
    'PENDING',
    'English',
    'Nigeria',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P175263-c3662024-83ad-4f36-8653-0341e64310db.pdf',
    'PENDING',
    'English',
    'Liberia',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P167183-16a688af-4973-49b5-b00a-1407a032d150.pdf',
    'PENDING',
    'English',
    'Nigeria',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P506602-0fe0528b-84f8-47ab-9d2a-33f400948917.pdf',
    'PENDING',
    'English',
    'China',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P507588-da1b54c0-2b56-4637-8e36-e843c7202594.pdf',
    'PENDING',
    'English',
    'Sierra Leone',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P508558-54acaeb2-e554-4f48-832c-50613fafd8af.pdf',
    'PENDING',
    'Spanish',
    'Argentina',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P177146-8b8a9606-8634-4108-b703-9df005369760.pdf',
    'PENDING',
    'English',
    'Burundi',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P177845-a5c2da72-58fa-467a-a19d-59276719bec6.pdf',
    'PENDING',
    'English',
    'Albania',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P177779-c3656a3f-12a6-4206-8150-f6769f63253c.pdf',
    'PENDING',
    'English',
    'Tajikistan',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P507482-a2f47330-b662-475d-908f-41fc3a027a04.pdf',
    'PENDING',
    'English',
    'Viet Nam',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/TF073388-3ffc79ff-8535-4e1a-9e45-31308da4ef57.pdf',
    'PENDING',
    'English',
    '',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P182116-d9b54ce7-b953-40a9-a22a-a1cd925ff551.pdf',
    'PENDING',
    'English',
    'Rwanda',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P509479-9781ba16-3dbc-4064-9d8f-8eaf9951e09d.pdf',
    'PENDING',
    'English',
    'World',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P168061-9d3ce94c-e8db-4603-ab22-ab3cfb5b530e.pdf',
    'PENDING',
    'English',
    'China',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P178161-df400de3-3aac-40da-b7a3-6a0867d281eb.pdf',
    'PENDING',
    'English',
    'Rwanda',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P151224-c7c412de-48e8-487e-b40c-598f20f4d5c2.pdf',
    'PENDING',
    'English',
    'Angola',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P160427-4fd55756-e35e-415c-8324-d977dc4715de.pdf',
    'PENDING',
    'English',
    'Eastern and Southern Africa',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P505963-29e6468c-9705-464a-a172-383e7b1bf9e4.pdf',
    'PENDING',
    'English',
    'Sudan',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P504085-d53bd008-c83a-446f-9f07-0fc363794cfb.pdf',
    'PENDING',
    'English',
...
INSERT INTO documents (
    ...
    'pdfs/P175977-4d60e665-ebbd-48bc-9ca6-4073a3ed2451.pdf',
    'PENDING',
    'English',
    'Honduras',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P171316-6977181d-10eb-48bc-a06a-4a5651a6328b.pdf',
    'PENDING',
    'English',
    'El Salvador',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P173825-4c06fbec-cd0f-4dee-9ae6-04e19d6cee37.pdf',
    'PENDING',
    'English',
    'Congo, Democratic Republic of',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P170734-f6b390d5-bb67-458c-911b-082d1af9537b.pdf',
    'PENDING',
    'English',
    'Nigeria',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P181200-ffd271c3-5d7e-46a1-bec8-d0c80b3cc99d.pdf',
    'PENDING',
    'English',
    'Ukraine',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P179599-0c80a6e9-71a8-4575-acdf-82e45623bd8b.pdf',
    'PENDING',
    'English',
    'Tuvalu',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P164785-c09f444c-3a66-4d4c-bfab-8dd7d770c78c.pdf',
    'PENDING',
    'English',
    'Pakistan',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P507865-34f9c0d6-7e1c-48d8-9e6a-206290d5790b.pdf',
    'PENDING',
    'English',
    'India',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P158418-2092dcae-d410-452f-b6cf-9f2b3ae51669.pdf',
    'PENDING',
    'English',
    'Turkiye',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P500758-944805c9-3b47-4447-8fb8-f00495f6546f.pdf',
    'PENDING',
    'English',
    'Tajikistan',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P179276-95ff26e7-2ca1-453f-b60b-92c8e1d1ebaf.pdf',
    'PENDING',
    'English',
    'Niger',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P170891-580fd493-a35c-460b-98d1-944bf6a71271.pdf',
    'PENDING',
    'English',
    'Albania',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P504691-dd9fadd0-148c-402c-b2f3-a023581ce43e.pdf',
    'PENDING',
    'English',
    'Comoros',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P176478-ca9dff2b-93d2-49ce-92a2-8c8b42a0cd25.pdf',
    'PENDING',
    'English',
    'Kiribati',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P501985-7bf553b3-992e-4ae5-ac8c-dd8376c4bc4f.pdf',
    'PENDING',
    'English',
    'Nepal',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P505025-bee4bba6-44ae-4e68-b5a5-55e4371e8682.pdf',
    'PENDING',
    'English',
    'Mali',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P181278-b8a32b02-4f1e-4179-8ba0-1ef0bd2cc671.pdf',
    'PENDING',
    'English',
    'Bhutan',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P164001-052b86db-9993-4b75-9e95-6a7a3de86195.pdf',
    'PENDING',
    'English',
    'Nigeria',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P159697-96301df8-f00c-4d29-9e8c-ea4609bf63be.pdf',
    'PENDING',
    'English',
    'Cote d''Ivoire',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P176731-9c276f0b-dae1-4e69-99d7-7df87ccf41ae.pdf',
    'PENDING',
    'English',
    'Ethiopia',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/IDU-52a84b8a-8d22-4516-b103-5601f4020e3e.pdf',
    'PENDING',
    'French',
    'Guinea',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P502471-a2abefec-4ecc-4e45-99dd-2404699b8e6c.pdf',
    'PENDING',
    'English',
    'Mozambique',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P173114-3fc1481d-49f4-46dd-bbfc-7c513f03f497.pdf',
    'PENDING',
    'English',
    'Comoros',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P175987-14d0cf94-33b3-4527-8696-1747d26f11b6.pdf',
    'PENDING',
    'English',
    'Gabon',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P506127-aaa15cd6-edbc-4fad-8c7f-96327649bdd7.pdf',
    'PENDING',
    'English',
    'Lebanon',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P512716-12549d2e-453e-4da4-9c80-b876da3de894.pdf',
    'PENDING',
    'English',
    'Angola',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P174798-70e0440d-423e-4b20-8a75-f9fc158d836a.pdf',
    'PENDING',
    'English',
    'India',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P171040-fd76cd0e-71b4-407b-8554-7656a04f03b0.pdf',
    'PENDING',
    'English',
    'Mozambique',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P147555-9b56f41f-261c-4d3f-a00c-ae5f44c923e3.pdf',
    'PENDING',
    'English',
    'Congo, Democratic Republic of',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P180085-2b7e6367-221f-42ea-a74f-9709b57525be.pdf',
    'PENDING',
    'English',
    'Western and Central Africa',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P175525-3b3087cd-8987-4188-b049-fdbbc5524e9f.pdf',
    'PENDING',
    'English',
    'Western and Central Africa',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P176924-831a1b27-8be7-4331-84a0-2b37ec4006e4.pdf',
    'PENDING',
    'English',
    'Gambia, The',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P179211-cfa51ee0-d280-4fe6-b637-ab9dfc7ff988.pdf',
    'PENDING',
    'English',
    'Central African Republic',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P175263-8ec25522-b450-43c2-b044-6ef2ace4e4d6.pdf',
    'PENDING',
    'English',
    'Liberia',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P160865-a818a945-77c3-43ef-9cb0-8e237b4d4898.pdf',
    'PENDING',
    'English',
    'Nigeria',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P165704-702083e0-cc31-49e5-8bc2-56c721c9b9c4.pdf',
    'PENDING',
    'English',
    'Malawi',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P154716-fbdb21d3-d8d9-4b2c-b8e3-12d468ff5bcf.pdf',
    'PENDING',
    'English',
    'China',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/IDU-6660fa9d-7f18-4851-81bc-01f0208ecf67.pdf',
    'PENDING',
    'English',
    'World',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P177816-4621d888-d28a-40c7-a1c6-4633519580e2.pdf',
    'PENDING',
    'English',
    'Eastern and Southern Africa',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P175768-75c3f01a-fec1-46ad-a4af-4ac0f14043b7.pdf',
    'PENDING',
    'English',
    'Benin',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P182069-76128491-89f1-49fa-854b-b381b990d473.pdf',
    'PENDING',
    'English',
    'Bangladesh',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P179786-d9a7738a-a6c8-4245-a485-9c086a290422.pdf',
    'PENDING',
    'English',
    'Romania',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P509818-f1b98da8-d7c8-459a-97f5-faae89a7049b.pdf',
    'PENDING',
    'English',
    'Kyrgyz Republic',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P175320-6eeb3234-b381-4a77-834a-58b129d9cf43.pdf',
    'PENDING',
    'English',
    'Paraguay',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P169134-7f71e04e-bd60-4579-8d6a-1af32c181ce0.pdf',
    'PENDING',
    'English',
    'Brazil',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P172605-88f301e0-1bf7-49cf-b5a9-1714e4320d40.pdf',
    'PENDING',
    'English',
    'Brazil',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P171645-69a02402-418c-4832-914c-1191e5d4c824.pdf',
    'PENDING',
    'English',
    'Turkiye',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P179067-40fa8577-66df-4087-840d-9ebce49fe506.pdf',
    'PENDING',
    'English',
    'St Maarten',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P504420-cd04d97e-3e4f-4c36-aca8-91e870dac15c.pdf',
    'PENDING',
    'English',
    'Uzbekistan',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/TF069031-3f17ce57-6289-4ccd-a7d5-e0965074f000.pdf',
    'PENDING',
    'English',
    '',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P178566-bc9afd91-e9f9-404f-af1d-2f07ab9503be.pdf',
    'PENDING',
    'English',
    'Eastern and Southern Africa',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P163533-81ee83a4-c300-4b62-9aad-cc60f08a8a3e.pdf',
    'PENDING',
    'English',
    'India',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P173734-83f79290-564a-403e-b8ff-4972927a5dee.pdf',
    'PENDING',
    'English',
    'Kyrgyz Republic',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P151439-4f113949-38df-46ee-91c9-bafa30ad4940.pdf',
    'PENDING',
    'English',
    'Ecuador',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P174637-eaf6cbed-2b97-4e24-ad3a-e0a652d36b28.pdf',
    'PENDING',
    'English',
    'Papua New Guinea',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P177902-eb6791d1-4ffd-4f1f-8f88-776f3fb9de3d.pdf',
    'PENDING',
    'English',
    'Nepal',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P176690-21f64d14-cdb5-447c-9b1e-a61d2b54a038.pdf',
    'PENDING',
    'English',
    'Djibouti',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P176435-62bc3103-ac50-4f88-b01e-6b5e04242120.pdf',
    'PENDING',
    'English',
    'World',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P168779-a2b229ed-9b51-4f1b-a2a2-5b2bf3170554.pdf',
    'PENDING',
    'English',
    'Niger',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P162263-be5f8780-a781-4d2f-a0f5-05b18da74ecc.pdf',
    'PENDING',
    'English',
    'Uzbekistan',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P178598-207d25c1-cccd-43cf-b7e5-4aa9a52b11a2.pdf',
    'PENDING',
    'English',
    'Burkina Faso',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P180163-997bbd88-dd9e-4b2a-a6c9-9cc2d323016a.pdf',
    'PENDING',
    'English',
    'Dominican Republic',
    '',
...
INSERT INTO documents (
    ...
    'pdfs/P175747-e73f6d61-0aee-4101-ae3c-8e693bad0476.pdf',
    'PENDING',
    'English',
    'Morocco',
    '',
...
INSERT INTO documents (
    ...
    '40043932',
    'Women’s Experiences of Vulnerability and Resilience in the Face of Climate Change: Narratives from Rural Guinea',
    '2025-09-18',
    '',
    'Report',
    'Publications & Research',
    1,
    NULL,
    'https://documents.worldbank.org/curated/en/099091825093056278/pdf/P501474-e0e3a6ef-3467-49a5-9257-362e0fb1d834.pdf',
    'pdfs/P501474-e0e3a6ef-3467-49a5-9257-362e0fb1d834.pdf',
    'PENDING',
    'English',
    'Guinea',
    '',
...
INSERT INTO documents (
    ...
    '40043991',
    'Central African Republic - WESTERN AND CENTRAL AFRICA- P177003- CAR Health Service Delivery and System Strengthening Project (SENI-Plus) - Procurement Plan',
    '2025-09-18',
    '',
    'Procurement Plan',
    'Project Documents',
    NULL,
    NULL,
    'https://documents.worldbank.org/curated/en/099091825135015396/pdf/P177003-6efa7f43-d679-41f9-846f-0ce8b3043ffa.pdf',
    'pdfs/P177003-6efa7f43-d679-41f9-846f-0ce8b3043ffa.pdf',
    'PENDING',
    'English',
    'Central African Republic',
    '',
...
INSERT INTO documents (
    ...
    NULL,
    NULL,
    'https://documents.worldbank.org/curated/en/099091825141033947/pdf/P161382-9335dc40-689b-48f2-98a6-1299bb287c4f.pdf',
    'pdfs/P161382-9335dc40-689b-48f2-98a6-1299bb287c4f.pdf',
    'PENDING',
    'English',
    'Marshall Islands',
    '',
...
INSERT INTO documents (
    ...
    '40044022',
    'Disclosable Version of the ISR - Barwaaqo - Somalia Water for Rural Resilience Project - P177627 - Sequence No : 6',
    '2025-09-18',
    '',
    'Implementation Status and Results Report',
    'Project Documents',
    NULL,
    NULL,
    'https://documents.worldbank.org/curated/en/099091825180046402/pdf/P177627-e8692c5c-f53d-4663-aaa4-da7b58d5c8b5.pdf',
    'pdfs/P177627-e8692c5c-f53d-4663-aaa4-da7b58d5c8b5.pdf',
    'PENDING',
    'English',
    'Somalia, Federal Republic of',
    '',
...
INSERT INTO documents (
    ...
    '40043982',
    'Western and Central Africa - WESTERN AND CENTRAL AFRICA- P176693- Sub-Saharan Africa Women?s Empowerment and Demographic Dividend Plus Project - Procurement Plan',
    '2025-09-18',
    '',
    'Procurement Plan',
    'Project Documents',
    NULL,
    NULL,
    'https://documents.worldbank.org/curated/en/099091825131016599/pdf/P176693-898b855b-ddc4-4e15-90d0-0d409811f2a3.pdf',
    'pdfs/P176693-898b855b-ddc4-4e15-90d0-0d409811f2a3.pdf',
    'PENDING',
    'English',
    'Western and Central Africa',
    '',
...
INSERT INTO documents (
    ...
    NULL,
    NULL,
    'https://documents.worldbank.org/curated/en/099091825024538546/pdf/P180409-17ec34fe-4391-44f3-bafc-1dcbb0661a2b.pdf',
    'pdfs/P180409-17ec34fe-4391-44f3-bafc-1dcbb0661a2b.pdf',
    'PENDING',
    'English',
    'Bosnia and Herzegovina',
    '',
...
INSERT INTO documents (
    ...
    NULL,
    NULL,
    'https://documents.worldbank.org/curated/en/099091825032512801/pdf/P180171-304970b1-7b4a-4f08-a11f-29f8801fc047.pdf',
    'pdfs/P180171-304970b1-7b4a-4f08-a11f-29f8801fc047.pdf',
    'PENDING',
    'English',
    'Eastern and Southern Africa',
    '',
...
INSERT INTO documents (
    ...
    '40043865',
    'East Asia and Pacific - EAST ASIA AND PACIFIC- P175659- Southeast Asia Regional Program on Combating Marine Plastics (SEA-MaP) - Procurement Plan',
    '2025-09-18',
    '',
    'Procurement Plan',
    'Project Documents',
    NULL,
    NULL,
    'https://documents.worldbank.org/curated/en/099091825014042539/pdf/P175659-e002992e-7a7f-4ff6-a342-7d3e6663d3a3.pdf',
    'pdfs/P175659-e002992e-7a7f-4ff6-a342-7d3e6663d3a3.pdf',
    'PENDING',
    'English',
    'East Asia and Pacific',
    '',
...
INSERT INTO documents (
    ...
    '40043945',
    'Ethiopia - EASTERN AND SOUTHERN AFRICA- P000755- ET ROAD SEC. DEV. PROG - Procurement Plan',
    '2025-09-18',
    '',
    'Procurement Plan',
    'Project Documents',
    NULL,
    NULL,
    'https://documents.worldbank.org/curated/en/099091825100523849/pdf/P000755-d713d674-e18a-43b9-bab1-928549c7bf3c.pdf',
    'pdfs/P000755-d713d674-e18a-43b9-bab1-928549c7bf3c.pdf',
    'PENDING',
    'English',
    '',
    '',
...
INSERT INTO documents (
    ...
    '40043893',
    'Djibouti - MID EAST,NORTH AFRICA,AFG,PAK- P174300- Horn of Africa Initiative: Djibouti Regional Economic Corridor Project - Procurement Plan',
    '2025-09-18',
    '',
    'Procurement Plan',
    'Project Documents',
    NULL,
    NULL,
    'https://documents.worldbank.org/curated/en/099091825044013326/pdf/P174300-f0f15c8d-a4ed-428d-b9c7-094336ef237f.pdf',
    'pdfs/P174300-f0f15c8d-a4ed-428d-b9c7-094336ef237f.pdf',
    'PENDING',
    'English',
    'Djibouti',
    '',
...
INSERT INTO documents (
    ...
    NULL,
    NULL,
    'https://documents.worldbank.org/curated/en/099091825011017851/pdf/P181278-56aacbd7-7b59-4f4c-bb10-1cbd3469259c.pdf',
    'pdfs/P181278-56aacbd7-7b59-4f4c-bb10-1cbd3469259c.pdf',
    'PENDING',
    'English',
    'Bhutan',
    '',
...
INSERT INTO documents (
    ...
    '40043861',
    'Ten Years of Impact : Putting People at the Center of Digital Transformation - Annual Report 2024-25',
    '2025-09-18',
    '',
    'Annual Report',
    'Publications & Research',
    1,
    NULL,
    'https://documents.worldbank.org/curated/en/099537409182599392/pdf/IDU-96feab7e-5091-4786-a2a1-6ab7850ee893.pdf',
    'pdfs/IDU-96feab7e-5091-4786-a2a1-6ab7850ee893.pdf',
    'PENDING',
    'English',
    'World',
    '',
...
INSERT INTO documents (
    ...
    '40044008',
    'Environmental and Social Impact Assessment Optimization of Public Finance Management in Honduras (P511035)',
    '2025-09-18',
    '',
    'Environmental and Social Assessment; Social Assessment; Environmental Assessment',
    'Project Documents',
    NULL,
    NULL,
    'https://documents.worldbank.org/curated/en/099091825171022863/pdf/P511035-9431244b-ffbc-4279-bb70-ed62393e912a.pdf',
    'pdfs/P511035-9431244b-ffbc-4279-bb70-ed62393e912a.pdf',
    'PENDING',
    'Spanish',
    'Honduras',
    '',
...
INSERT INTO documents (
    ...
    '40043912',
    'Central Africa - WESTERN AND CENTRAL AFRICA- P175235- Central Africa Regional Waterways Project - Procurement Plan',
    '2025-09-18',
    '',
    'Procurement Plan',
    'Project Documents',
    NULL,
    NULL,
    'https://documents.worldbank.org/curated/en/099091825075534080/pdf/P175235-572d6764-b2d7-4d4a-9051-10c92c4d1cbf.pdf',
    'pdfs/P175235-572d6764-b2d7-4d4a-9051-10c92c4d1cbf.pdf',
    'PENDING',
    'English',
    'Central Africa',
    '',
...
INSERT INTO documents (
    ...
    '40043913',
    'Serbia - EUROPE AND CENTRAL ASIA- P500611- Second Real Estate Management Project - Procurement Plan',
    '2025-09-18',
    '',
    'Procurement Plan',
    'Project Documents',
    NULL,
    NULL,
    'https://documents.worldbank.org/curated/en/099091825080035656/pdf/P500611-bb47e3df-6543-4a45-97ff-0b0ca6d5d14a.pdf',
    'pdfs/P500611-bb47e3df-6543-4a45-97ff-0b0ca6d5d14a.pdf',
    'PENDING',
    'English',
    'Serbia',
    '',
...
INSERT INTO documents (
    ...
    NULL,
    NULL,
    'https://documents.worldbank.org/curated/en/099092225202016175/pdf/P174114-ed05ff1a-9265-4865-8362-32f21e46f1fb.pdf',
    'pdfs/P174114-ed05ff1a-9265-4865-8362-32f21e46f1fb.pdf',
    'PENDING',
    'English',
    'Nigeria',
    '',
...
INSERT INTO documents (
    ...
    '40044007',
    'Niger - WESTERN AND CENTRAL AFRICA- P177043- RESILAND Niger Integrated Landscape Management Project - Procurement Plan',
    '2025-09-18',
    '',
    'Procurement Plan',
    'Project Documents',
    NULL,
    NULL,
    'https://documents.worldbank.org/curated/en/099091825171012307/pdf/P177043-1526ba45-f434-4959-8ee7-be8ce54cc786.pdf',
    'pdfs/P177043-1526ba45-f434-4959-8ee7-be8ce54cc786.pdf',
    'PENDING',
    'English',
    'Niger',
    '',
...
INSERT INTO documents (
    ...
    '40043808',
    'Tonga - EAST ASIA AND PACIFIC- P180965- Health Enhancement and Resiliency in Tonga Project - Procurement Plan',
    '2025-09-18',
    '',
    'Procurement Plan',
    'Project Documents',
    NULL,
    NULL,
    'https://documents.worldbank.org/curated/en/099091725213069720/pdf/P180965-642eed8e-c80a-49dd-bfdc-6e756abd2255.pdf',
    'pdfs/P180965-642eed8e-c80a-49dd-bfdc-6e756abd2255.pdf',
    'PENDING',
    'English',
    'Tonga',
    '',
...
INSERT INTO documents (
    ...
    '40043889',
    'Cambodia - EAST ASIA AND PACIFIC- P162971- Cambodia Higher Education Improvement Project - Procurement Plan',
    '2025-09-18',
    '',
    'Procurement Plan',
    'Project Documents',
    NULL,
    NULL,
    'https://documents.worldbank.org/curated/en/099091825040041642/pdf/P162971-5b926881-ba03-476a-94a5-e866b4c79aa6.pdf',
    'pdfs/P162971-5b926881-ba03-476a-94a5-e866b4c79aa6.pdf',
    'PENDING',
    'English',
    'Cambodia',
    '',
...
INSERT INTO documents (
    ...
    '40043883',
    'Azerbaijan - EUROPE AND CENTRAL ASIA- P171250- Employment Support Project - Procurement Plan',
    '2025-09-18',
    '',
    'Procurement Plan',
    'Project Documents',
    NULL,
    NULL,
    'https://documents.worldbank.org/curated/en/099091825032035647/pdf/P171250-f130d695-379a-434c-94a4-1cdcd1fd6c96.pdf',
    'pdfs/P171250-f130d695-379a-434c-94a4-1cdcd1fd6c96.pdf',
    'PENDING',
    'English',
    'Azerbaijan',
    '',
...
INSERT INTO documents (
    ...
    '40043931',
    'Official Documents- Project Agreement for Credit 7281-CI.pdf',
    '2025-09-18',
    '',
    'Project Agreement',
    'Project Documents',
    NULL,
    NULL,
    'https://documents.worldbank.org/curated/en/099091825093023185/pdf/P178362-540bb4da-cabb-442b-a18b-0c5108903509.pdf',
    'pdfs/P178362-540bb4da-cabb-442b-a18b-0c5108903509.pdf',
    'PENDING',
    'English',
    'Cote d''Ivoire',
    '',
...
INSERT INTO documents (
    ...
    NULL,
    NULL,
    'https://documents.worldbank.org/curated/en/099091825100028978/pdf/P178040-b64c3790-272f-49cc-bb5b-532c662d1a9b.pdf',
    'pdfs/P178040-b64c3790-272f-49cc-bb5b-532c662d1a9b.pdf',
    'PENDING',
    'English',
    'Angola',
    '',
...
INSERT INTO documents (
    ...
    '40043900',
    'Cameroon - WESTERN AND CENTRAL AFRICA- P173240- Acceleration of the Digital Transformation of Cameroon Project - Procurement Plan',
    '2025-09-18',
    '',
    'Procurement Plan',
    'Project Documents',
    NULL,
    NULL,
    'https://documents.worldbank.org/curated/en/099091825061010691/pdf/P173240-3898e521-b8f0-48cb-b4a2-9b5c9438fe26.pdf',
    'pdfs/P173240-3898e521-b8f0-48cb-b4a2-9b5c9438fe26.pdf',
    'PENDING',
    'English',
    'Cameroon',
    '',
...
INSERT INTO documents (
    ...
    '40043901',
    'India - SOUTH ASIA- P168633- Kerala Solid Waste Management Project - Procurement Plan',
    '2025-09-18',
    '',
    'Procurement Plan',
    'Project Documents',
    NULL,
    NULL,
    'https://documents.worldbank.org/curated/en/099091825061013489/pdf/P168633-5a6a8792-0b51-43e7-9cf1-e94dc64332d6.pdf',
    'pdfs/P168633-5a6a8792-0b51-43e7-9cf1-e94dc64332d6.pdf',
    'PENDING',
    'English',
    'India',
    '',
...
INSERT INTO documents (
    ...
    '40043927',
    'Official Documents- Disbursement and Financial Information Letter for PPR Grant TF0C9689.pdf',
    '2025-09-18',
    '',
    'Disbursement Letter',
    'Project Documents',
    NULL,
    NULL,
    'https://documents.worldbank.org/curated/en/099091825091515808/pdf/P512354-9fbe2c44-7fe7-4b2e-ba9c-13ade49c06c8.pdf',
    'pdfs/P512354-9fbe2c44-7fe7-4b2e-ba9c-13ade49c06c8.pdf',
    'PENDING',
    'English',
    'Turkmenistan',
    '',
